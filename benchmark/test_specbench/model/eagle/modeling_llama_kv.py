...
class LlamaRotaryEmbedding(nn.Module):
    ...
    Args:
        ...
        base (int, optional): The base value for rotational encoding. Default is 500000.
...
class LlamaLinearScalingRotaryEmbedding(LlamaRotaryEmbedding):
    ...
    Args:
        ...
        base (int, optional): The base value for the rotational embeddings. Default is 500000.
...
class LlamaDynamicNTKScalingRotaryEmbedding(LlamaRotaryEmbedding):
    ...
    def __init__(
        ...
        Args:
            ...
            base (int, optional): Base value for scaling calculations. Default is 500000.
